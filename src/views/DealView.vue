...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Sep 2020 00:22:43 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="/doctorlist"><i class="fe fe-user-plus"></i> <span>Doctors</span></a>
							</li>
							<li> 
								<a href="/patientlist"><i class="fe fe-user"></i> <span>Patients</span></a>
							</li>
							<li> 
...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Sep 2020 00:23:02 GMT -->
</html>
</template>
<script>
